...
nmap <A-1> :tabn 1<CR>
imap <A-1> <C-O>:tabn 1<CR><ESC>
nmap <A-2> :tabn 2<CR>
imap <A-2> <C-O>:tabn 2<CR><ESC>
nmap <A-3> :tabn 3<CR>
imap <A-3> <C-O>:tabn 3<CR><ESC>
nmap <A-4> :tabn 4<CR>
imap <A-4> <C-O>:tabn 4<CR><ESC>
nmap <A-5> :tabn 5<CR>
imap <A-5> <C-O>:tabn 5<CR><ESC>
nmap <A-6> :tabn 6<CR>
imap <A-6> <C-O>:tabn 6<CR><ESC>
nmap <A-7> :tabn 7<CR>
imap <A-7> <C-O>:tabn 7<CR><ESC>
nmap <A-8> :tabn 8<CR>
imap <A-8> <C-O>:tabn 8<CR><ESC>
nmap <A-9> :tabn 9<CR>
imap <A-9> <C-O>:tabn 9<CR><ESC>
nmap <A-0> :tabn 10<CR>
imap <A-0> <C-O>:tabn 10<CR><ESC>
